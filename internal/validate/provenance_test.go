...
// tempValidator builds a CiteValidator over a platform root containing
// knowledge-base/eval/failure-modes/v1.yaml (mirrors the challenge-side
// provenance test).
func tempValidator(t *testing.T) *challenge.CiteValidator {
	t.Helper()
	root := t.TempDir()
